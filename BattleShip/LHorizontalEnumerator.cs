...
{
    class LHorizontalEnumerator : GridEnumerator
    {
        UInt32 m_CurrRow;
        UInt32 m_CurrCol;
        UInt32 m_limit;

        public LHorizontalEnumerator()
        {
        ...
        override public object Current 
        {
            get
            {
                   if (m_limit > m_Container.GetRows())
                    ...
                    if (((Int32)(m_StartCol - m_CurrCol) < 0) || (null != m_Container.getOccupied(m_CurrRow, m_StartCol - m_CurrCol)))
                        throw new Exception();
